    ...
    if (navigator.userAgent.match(/Android/i)
      ...
      $('<div/>')
        ...
        $(document).on("click", ".newbutton", function () {
            ...
            $("#linkidspotify").wrap('<a href="https://open.spotify.com/artist/1w6DbV6lidWZ9semwbUpgJ" />');
            $("#linkiditunes").wrap('<a href="https://itunes.apple.com/us/album/summer-dads/id994426745" target="_blank" />');
            $("#linkidgplay").wrap('<a href="https://play.google.com/store/music/album/Vektor_Corps_Summer_Dads?id=B6wofhgcczozmr5bkhj4gzumkb4" target="_blank" />');
            $("#linkidsoundcloud").wrap('<a href="https://soundcloud.com/vektorcorps" target="_blank" />');
            $("#linkidfacebook").wrap('<a href="https://www.facebook.com/profile.php?id=100009378230114&fref=ts" target="_blank" />');
